        ...
        {email ? (
          <div className="hidden md:flex items-center gap-3">
            ...
            <form action={signOut}>
              <button
                type="submit"
                className="text-sm font-medium text-gray-600 hover:text-[var(--color-danger)] transition-colors px-3 py-2"
              >
                Cerrar sesión
              </button>
            </form>
          ...
          {email && (
            <li className="md:hidden border-t border-gray-200 mt-2 pt-2 flex flex-col gap-1">
              ...
              <form action={signOut}>
                <button
                  type="submit"
                  className="w-full text-left px-3 py-2 text-sm text-[var(--color-danger)] hover:bg-gray-100 rounded"
                >
                  Cerrar sesión
                </button>
              </form>
